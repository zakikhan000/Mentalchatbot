...
# Preprocess the text: tokenizing and removing stopwords
def preprocess_text(text):
    doc = nlp(text.lower())
    tokens = [token.text for token in doc if not token.is_stop and token.is_alpha]
    return ' '.join(tokens)

# Initial training data related to anxiety and depression relief
qa_data = [
...
# Build the chatbot model using TF-IDF and Naive Bayes
...
# Scrape content from multiple mental health and daily life websites
